...
.\build.ps1 -Name icons-feather -Version 1.2.3
```
...
```
<project>/.config/icons-feather/<packaging>.build-host
$HOME/.config/icons-feather/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-feather
```
