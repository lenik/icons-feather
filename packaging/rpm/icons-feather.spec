...
Feather Icons
.
Provides icon assets under /usr/share/icons-feather, a preview index, and a
launcher `icons-feather` (`iconlib -l feather`).
...
%files
%{_bindir}/icons-feather
%{_datadir}/bash-completion/completions/icons-feather
%{_mandir}/man1/icons-feather.1*
%{_datadir}/icons-feather/
%{_datadir}/doc/icons-feather/
